...
function AdminPage() {
  ...
  // =====================================================
  // FIREBASE FCM NOTIFICATIONS SETUP
  // =====================================================
  ...
  useEffect(() => {
    const setupFCM = async () => {
      ...
      if (token) {
        console.log("Admin FCM Token active:", token);
        // Backend sync call yahan add ho sakti hai (e.g. axios.post('/api/save-token', { token }))
      }
    };

    setupFCM();

    // Active screen par push notification Receive karne ke liye
    onMessageListener()
      .then((payload: any) => {
        alert(
